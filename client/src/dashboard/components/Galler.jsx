  ...
  return (
    <div className="w-screen h-screen fixed left-0 top-0 z-[9999]">
      <div className="w-full h-full relative">
        ...
        <div
          className="absolute bg-white w-[50%] p-3 rounded-lg h-[85vh] overflow-auto 
        ...
        >
          ...
          <div>
            <label
              htmlFor="images"
              className={`w-full h-[150px] flex rounded text-[#404040]
          ...
          <div className="grid grid-cols-4 gap-x-2 mt-3">
            {
              ...
              images.length > 0 && images.map((img,i)=><div onClick={()=> copy_url(img.url)} key={i} className="cursor-pointer">
                  <img src={img.url} alt="" />
                </div>)
